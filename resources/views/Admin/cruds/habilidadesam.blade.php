...
@section('administrar', 'Habilidades de A. y/o M.')

@section('administrar_s', 'Habilidade de A. y/o M.')
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" id="buscarParticipante" class="form-control" placeholder="Escribe para buscar..."
                autocomplete="off">
            <select name="participante_seleccionado" id="participante_seleccionado" class="form-control mt-2" size="5">
            </select>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    data.forEach(function (participante) {
                        var proyectos = participante.proyectos ? participante.proyectos.split(',').join(', ') : 'Sin proyectos';

                        var option = $('<option></option>')
                            .attr('value', participante.id)
                            .attr('title', 'Proyectos en los que participa: ' + proyectos) // Tooltip con los proyectos.
