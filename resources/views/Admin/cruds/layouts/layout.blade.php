...
<head>
    ...
    <style>
        ...
        table.table td a {
            font-weight: bold;
            color: #566787;
            /* display: inline-block; Removido, ahora se maneja con flexbox en .action-buttons a */
...
<body>
    ...
    {{-- Asegúrate de usar la versión correcta de Bootstrap que corresponda con tu CSS. Si tu CSS es de Bootstrap 4, usa el JS de Bootstrap 4. --}}
</body>
