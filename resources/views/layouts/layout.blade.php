        ...
        editProfileModal.on('show.bs.modal', function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Campo de nombre único, usa el nombre de la tabla de perfil si existe,
                    // de lo contrario usa el nombre de la tabla 'users'.
                    const initialName = profileData && profileData.nombre ? profileData.nombre : userName;

                    formHtml += `
                        <div class="form-group">
                            <label for="name">Nombre:</label>
                            <input type="text" class="form-control" id="name" name="name" value="${initialName || ''}" required>
                    ...
                    // Campos específicos de cada rol (sin duplicar el nombre)
                    if (userRole === 'alumno') {
                        formHtml += `
                            <div class="form-group">
