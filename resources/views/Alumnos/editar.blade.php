        ...
        <div class="col-12 col-md-12 col-lg-10">
            <div class="card shadow-lg rounded-lg">
                <div class="card-header bg-gradient-primary text-white text-center py-3 rounded-top">
                    <h2 class="mb-0">Editar datos del Proyecto: <span
                            class="font-weight-bold">{{ $proyecto->nombre }}</span></h2>
                </div>
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('proyectos.update', $proyecto->clave_proyecto) }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control" id="clave_proyecto"
                                value="{{ $proyecto->clave_proyecto }}" disabled readonly>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre"
                                        value="{{ old('nombre', $proyecto->nombre) }}" required maxlength="50">
                                    @error('nombre')
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nombre_descriptivo"
                                        name="nombre_descriptivo"
                                        value="{{ old('nombre_descriptivo', $proyecto->nombre_descriptivo) }}" required
                                        maxlength="100">
                                    ...
                                    <select class="form-control" id="categoria" name="categoria" required>
                                        ...
                                        @foreach ($categorias as $categoria)
                                            <option value="{{ $categoria->idCategoria }}"
                                                {{ old('categoria', $proyecto->categoria) == $categoria->idCategoria ? 'selected' : '' }}>
                                                {{ $categoria->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control" id="tipo" name="tipo" required>
                                        ...
                                        @foreach ($tipos as $tipo)
                                            <option value="{{ $tipo->idTipo }}"
                                                {{ old('tipo', $proyecto->tipo) == $tipo->idTipo ? 'selected' : '' }}>
                                                {{ $tipo->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="area_aplicacion" name="area_aplicacion"
                                value="{{ old('area_aplicacion', $proyecto->area_aplicacion) }}" maxlength="50">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="naturaleza_tecnica" name="naturaleza_tecnica"
                                value="{{ old('naturaleza_tecnica', $proyecto->naturaleza_tecnica) }}" maxlength="50">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="objetivo" name="objetivo" rows="4" maxlength="600" required>{{ old('objetivo', $proyecto->objetivo) }}</textarea>
                            @error('objetivo')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control" id="video" name="video"
                                value="{{ old('video', $proyecto->video) }}"
                        ...
                        <div id="requerimientos-container">
                            @forelse (old('requerimientos', $requerimientos) as $index => $req)
                                <div class="form-row mb-2 dynamic-field">
                                    <div class="col-md-6">
                                        <input type="text" name="requerimientos[{{ $index }}][descripcion]"
                                            ...
                                            value="{{ $req->descripcion ?? ($req['descripcion'] ?? '') }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="requerimientos[{{ $index }}][cantidad]"
                                            ...
                                            value="{{ $req->cantidad ?? ($req['cantidad'] ?? '') }}" required>
                        ...
                        <div id="resultados-container">
                            @forelse (old('resultados', $resultados) as $index => $res)
                                <div class="form-row mb-2 dynamic-field">
                                    <div class="col-md-10">
                                        <input type="text" name="resultados[{{ $index }}][descripcion]"
                                            ...
                                            value="{{ $res->descripcion ?? ($res['descripcion'] ?? '') }}" required>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.btn-remove-field', function() {
                    ...
                    // Opcional: Si el orden de los índices en el backend es estricto,
                    // puedes llamar a una función para reindexar aquí después de eliminar.
                    // Sin embargo, para la mayoría de los CRUDs de "elementos hijos",
                    // eliminar y luego volver a insertar todos es más robusto como ya lo tienes en el controlador.
                });
            });
        </script>
    @endpush
