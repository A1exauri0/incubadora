        ...
        @foreach ($propuestas as $propuesta)
            <tr>
                ...
                <td>
                    ...
                    @if ($propuesta->etapa == 1)
                        {{-- PENDIENTE (pendiente para el asesor) --}}
                        <form action="{{ route('asesor.proyectos.propuestas.review', $propuesta->clave_proyecto) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#rejectModal').on('show.bs.modal', function(event) {
                ...
                modal.find('#rejectForm').attr('action', '{{ url('/asesor/propuestas') }}/' +
