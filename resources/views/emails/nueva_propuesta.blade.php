...
<head>
    ...
    <title>Nueva Propuesta de Proyecto - IncubaTec ITTG</title>
    <style>
        ...
        /* Caja de detalles del proyecto (similar al token-box) */
        .project-details-box {
            background-color: #eaf6ff; /* Fondo azul claro */
            border: 1px dashed #a4d2ed; /* Borde punteado para destacarlo */
            padding: 20px; /* Más relleno */
            font-size: 16px; /* Ajustado para legibilidad de texto */
            color: #007bff; /* Color azul primario */
            border-radius: 6px;
            margin: 25px 0; /* Más margen alrededor de la caja */
            word-break: break-all; /* Asegura que los textos largos se ajusten */
        }
        ...
        @media only screen and (max-width: 600px) {
            ...
            .project-details-box { /* Ajustado de .token-box */
                font-size: 14px;
                padding: 15px;
            }
            .button {
    ...
    <div class="email-wrapper">
        <div class="email-container">
            ...
            <div class="content">
                ...
                <p>Se ha enviado una nueva propuesta de proyecto que requiere su revisión. A continuación, los detalles:</p>
                <div class="project-details-box">
                    <ul>
                        <li><strong>Nombre del Proyecto:</strong> {{ $projectName }}</li>
                        <li><strong>Clave del Proyecto:</strong> {{ $projectClave }}</li>
                        <li><strong>Enviado por:</strong> {{ $submitterName }}</li>
                    </ul>
                </div>
                <p>Por favor, haga clic en el siguiente botón para ir directamente a la página de revisión de propuestas:</p>
                <div class="button-wrapper">
                    <a href="{{ $proposalLink }}" class="button">Revisar Propuestas</a>
                </div>
